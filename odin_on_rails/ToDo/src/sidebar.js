...
const Sidebar = () => {
  ...
  function minMax(el) {
    return format(el([new Date(), new Date(2030, 1, 11)]), "MM-dd-yyyy");
  }
  ...
  function escape(e) {
    if (e.key === "Escape") {
      const taskModalContainer = document.querySelector(
  ...
  document.querySelector("#all-tasks-link").addEventListener("click", () => {
    ...
    const prioritySubmenuContainer = document.querySelector(
      "#priority-submenu-container"
    );
    const listSubmenuContainer = document.querySelector(
      "#link-submenu-container"
    );
  ...
  lists.addEventListener("click", () => {
    ...
    if (document.querySelector("#link-submenu-container")) {
      if (
        document
          .querySelector("#link-submenu-container")
          .classList.contains("slide-in-top")
      ) {
        retractSubmenu(
          document.querySelector("#link-submenu-container"),
          caret,
          1
        );
      }
  ...
  prioritySidebar.addEventListener("click", () => {
    ...
    if (prioritySubmenuContainer) {
      if (
        document
          .querySelector("#priority-submenu-container")
          .classList.contains("slide-in-top")
      ) {
        retractSubmenu(
          document.querySelector("#priority-submenu-container"),
          caret,
          1
        );
      }
